            ...
            <div class="col-md-4 ov">
                ...
                <div class="card card-body">
                    <form action="../../../sistema/procesos/save/saveroles.php" method="POST">
                        ...
                        <div class="form-group">
                            <label>ROL:</label>
                            <input type="text" name="textrol" class="form-control" placeholder="Ej: Miembro" autofocus>
                        </div>
            ...
            <div class="col-md-8">
                <table class="table table-striped" style="text-align: center">
                    ...
                    while ($row = mysqli_fetch_array($resultado)) { ?>
                        ...
                        <td class="ov">
                            <a href="../../../sistema/procesos/edit/editroles.php?id=<?php echo $row['rolid'] ?>" class="btn btn-secondary">
                                <i class="fas fa-marker"></i>
                            </a>
                            <a href="../../../sistema/procesos/delete/deleteroles.php?id=<?php echo $row['rolid'] ?>" class="btn btn-danger">
