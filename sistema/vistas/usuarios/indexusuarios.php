    ...
    <div class="shadow-lg p-3 mb-5 bg-white rounded">
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col-md-9">
                        <h4>Administrador de Empledos</h4>
                    </div>
                    <div class="col-md-3">
                        ...
                        <div class="shadow-lg p-3 mb-5 bg-white rounded">
                            <div class="card card-body">
                                <form action="../../../sistema/procesos/save/saveusuarios.php" method="POST">
                                    ...
                                    <div class="form-group">
                                        <label>Nombre:</label>
                                        <input type="text" name="textunom" class="form-control"
                                            placeholder="Ej: Alvin Delgado" autofocus>
                                    </div>
                                    <div class="form-group">
                                        <label>Email:</label>
                                        <input type="text" name="textuemail" class="form-control"
                                            placeholder="Ej: alvindelgado@gmail.com" autofocus>
                                    </div>
                                    <div class="form-group">
                                        <label>Usuario:</label>
                                        <input type="text" name="textutag" class="form-control" placeholder="Ej: AlvinD"
                                            autofocus>
                                    </div>
                                    <div class="form-group">
                                        <label>Clave:</label>
                                        <input type="text" name="textukey" class="form-control" placeholder="Ej: abv123"
                                            autofocus>
                                    </div>
                                    <div class="form-group">
                                        <label>Rol:</label>
                                        <input type="text" name="texturol" class="form-control" placeholder="Ej: 1"
                                            autofocus>
                                    </div>
                    ...
                    <div class="col-md-9">
                        ...
                        while ($row = mysqli_fetch_array($resultado)) { ?>
                                <tr>
                                    ...
                                    <td class="ov">
                                        <a href="../../../sistema/procesos/edit/editusuarios.php?id=<?php echo $row['empid'] ?>"
                                            class="btn btn-secondary">
                                            <i class="fas fa-marker"></i>
                                        </a>
                                        <a href="../../../sistema/procesos/delete/deleteusuarios.php?id=<?php echo $row['empid'] ?>"
