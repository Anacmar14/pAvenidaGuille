$(document).ready(function () {
  ...
  opcion = 4;
  tablaPersonas = $("#tablaProveedores").DataTable({
      language: {
        "decimal": "",
        "emptyTable": "No hay información",
    ...
    opcion = 4;
    tablaPersonas = $("#tablaHistorialVentas").DataTable({
      language: {
        "decimal": "",
        "emptyTable": "No hay información",
      ...
      columns: [
        ...
        { data: "fvtotal" },
        { defaultContent:
            "<div class='text-center'><div class='btn-group'><button class='btn btn-primary btn-sm btnVerMasDetalleVenta' title='Ver Mas'><i class='material-icons'>remove_red_eye</i></button>",
        },
