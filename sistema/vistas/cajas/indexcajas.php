...
<body>
            ...
            <div class="card">
                <div class="saludos">
                    ...
                    <div class="card-header" style="text-align:center">
                        <h4>Datos de la Caja Número <label id="numeroDeCaja"></label></h4>
                    </div>
                    <div class="row">
                            <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        <div class="justify-content-end">
                                            <div class="justify-content-between" style="display: flex; flex-direction: row;">
                                                <div class='totalDivCol'
                                                    style="display: flex; align-items: center; margin-right: 0px; padding: 5px;">
                                                    <div class='input-group-prepend'>
                                                        <span class='input-group-text'>Numero de Caja:</span>
                                                    </div>
                                                    <input type="text" class="form-control inputIdCaja" disabled
                                                        style='width: 90px;'>
                                                </div>
                                                <div class='totalDivCol'
                                                    style="display: flex; align-items: center; margin-right: 0px; padding: 5px;">
                                                    ...
                                                    <input type="text" class="form-control inputFecha" disabled
                                                        style='width: auto;'>
                                                </div>
                                                <div class='totalDivCol'
                                                    style="display: flex; align-items: center; margin-right: 0px; padding: 5px;">
                                                    ...
                                                    <input type="text" class="form-control inputCajero" disabled
                                                        style='width:100px;'>
                                                </div>
                                                <div class='totalDivCol'
                                                    style="display: flex; align-items: center; margin-right: 0px; padding: 5px;">
                                                    ...
                                                    <input type="text" class="form-control inputMontoInicial" disabled
                                                        style='width:100px;'>
                                                </div>
                                                <div class='totalDivCol'
                                                    style="display: flex; align-items: center; margin-right: 0px; padding: 5px;">
                                                    ...
                                                    <input type="text" class="form-control inputSaldo" placeholder="Saldo"
                                                        disabled>
                                                </div>
                                            </div>
                                            <div class="justify-content-between" style="display: flex; flex-direction: row;">
                                                <div class='totalDivCol'
                                                    ...
                                                    <input type="text" class="form-control inputIngVen" placeholder="0" disabled
                                                        style='width: 100px;'>
                                                </div>
                                                <div class='totalDivCol'
                                                    style="display: flex; align-items: center; margin-right: 0px; padding: 5px;">
                                                    ...
                                                    <input type="text" class="form-control inputEgrComp" placeholder="0"
                                                ...
                                                <div class='totalDivCol'
                                                    ...
                                                    <input type="text" class="form-control inputIngMov" placeholder="0" disabled
                                                        style='width:100px;'>
                                                </div>
                                                <div class='totalDivCol'
                                                    style="display: flex; align-items: center; margin-right: 0px; padding: 5px;">
                                                    ...
                                                    <input type="text" class="form-control inputEgrMov" placeholder="0"
                                                        disabled>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="card card-header" style="text-align:center">
                        ...
                        <h4>Tabla de Movimientos de la Caja Actual</h4>
                    </div>
                ...
                <div class="card card-header" style="text-align:left" id="antesDeMensaje">
                    <h4>Caja</h4>
                </div>
    ...
    <div id="backModal">
        <div class="drower">
            ...
            <div class="inputBox" style="margin-top: 3%; margin-buttom: 2%;">
                ...
                <input type="text" class="form-control" placeholder="Monto inicial" id="fechaHora" aria-label="Username"
                    aria-describedby="basic-addon1">
            </div>

            <div class="inputBox" style="margin-top: 3%; margin-bottom: 2%;">
                <span class="input-group-text" id="basic-addon1">Cajero: </span>
                <input type="text" class="form-control" placeholder="Monto inicial" id="nombreCajero"
                    aria-label="Cajero: cajero@cajerito.com" aria-describedby="basic-addon1">
            </div>
            <div class="inputBox">
                <span class="input-group-text" id="basic-addon1">Monto Inicial: </span>
                <input type="text" class="form-control" placeholder="Ingrese Monto inicial" id="inputApertura"
                    aria-label="Username" aria-describedby="basic-addon1" style="width:200px">
            </div>
            <hr style="color: gray">
            <div class="footerModalDos">
                <div class="d-flex justify-content-end">
                    <button id="subirCaja" class="btn btn-success" style="width:100px"> Abrir Caja</button>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="card-header">
                    <div class="headerModal">
                        <div class="d-flex justify-content-between">
                            <h3 class="tituloTicket">Arqueo Detallado de Caja Número <label id="numeroDeCaja2"></label>
                            </h3>
                    ...
                    <div class="tab-pane fade show active" id="tablaCajas" role="tabpanel" aria-labelledby="home-tab">
                        <div class="p-2 flex-grow-1 bd-highlight">
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="table-responsive">
                                        <table id="tablaCaja" class="table table-striped"
                                            style="width:100%; text-align: center">
                                            <thead class="thead-dark">
                                                <tr>
                                                    <th>Folio</th>
                    ...
                    <div class="tab-pane fade show active" id="tablaCajas" role="tabpanel" aria-labelledby="home-tab">
                        <div class="p-2 flex-grow-1 bd-highlight">
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="table-responsive">
                                        <table id="tablaCajaDos" class="table table-striped"
                                            style="width:100%; text-align: center">
                                            <thead class="thead-dark">
                                                <tr>
                                                    <th>Folio</th>
    ...
    <div id="CajaCerrada">
        <div class="shadow-lg p-3 mb-5 bg-white rounded">
            <div class="card">
                <div class="drowerCaja" style="width: 500px;">
                    <div class="headerModal">
                        <div class="d-flex justify-content-end">
                    ...
                    <div class="d-flex justify-content-center">
                        <h3>¿Estás seguro de cerrar la caja actual?</h3>
                    </div>
                    <br>
                    <div class="headerModal">
                        <div class="d-flex justify-content-end">
                            <button id="cerrarCaja" class="btn btn-danger" style="width: 100px;">Cancelar</button>
                            <button id="cajaSi" class="btn btn-success" style="width: 150px; margin-left:20px;">Cerrar
                                Caja</button>
                        </div>
                    </div>
                </div>
