            ...
            ?>
                        <div class="shadow-lg p-3 mb-5 bg-white rounded">
                            <div class="card card-body">
                                <form action="../../../sistema/procesos/save/saveclientes.php" method="POST">
                                    ...
                                    <div class="form-group">
                                        <label>Nombre:</label>
                                        <input type="text" name="textcnom" class="form-control"
                                            placeholder="Ej: Lev Gallego" autofocus>
                                    </div>
                                    <div class="form-group">
                                        <label>Email:</label>
                                        <input type="text" name="textcemail" class="form-control"
                                            placeholder="Ej: levgalleo@gmail.com" autofocus>
                                    </div>
                                    <div class="form-group">
                                        <label>Direccion:</label>
                                        <input type="text" name="textcdire" class="form-control"
                                            placeholder="Ej: Av San Cristobal 303" autofocus>
                                    </div>
                                    <div class="form-group">
                                        <label>Telefono:</label>
                                        <input type="text" name="textctele" class="form-control"
                                            placeholder="Ej: 3876223599" autofocus>
                                    </div>
                ...
                while ($row = mysqli_fetch_array($resultado)) { ?>
                                <tr>
                                    ...
                                    <td class="ov">
                                        <a href="../../../sistema/procesos/edit/editclientes.php?id=<?php echo $row['clid'] ?>"
                                            class="btn btn-secondary">
                                            <i class="fas fa-marker"></i>
                                        </a>
                                        <a href="../../../sistema/procesos/delete/deleteclientes.php?id=<?php echo $row['clid'] ?>"
                                            class="btn btn-danger oc">
