            ...
            <div class="col-md-4 oc">
                ...
                <div class="card card-body oc">
                    <form action="../../../sistema/procesos/save/savearticulos.php" method="POST">
                        ...
                        <div class="form-group">
                            <label>Codigo:</label>
                            <input type="text" name="textcodigo" class="form-control" placeholder="Ej: 232183219"
                                autofocus>
                        </div>
                        <div class="form-group">
                            <label>Nombre:</label>
                            <input type="text" name="textanom" class="form-control" placeholder="Ej: Fanta 500ml"
                                autofocus>
                        </div>
                        <div class="form-group">
                            <label>Id Categoria:</label>
                            <input type="text" name="textcategoria" class="form-control"
                ...
                <table class="table table-striped" style="text-align: center">
                    ...
                    while ($row = mysqli_fetch_array($resultado)) { ?>
                        <tr>
                            ...
                            <td>
                                <?php echo $row['procodigo'] ?>
                            </td>
                            <td>
                                <?php echo $row['pronombre'] ?>
                            </td>
                            <td>
                                <?php echo $row['canom'] ?>
                            </td>
                            <td>
                                <?php echo $row['prostockactual'] ?>
                            </td>
                            <td>
                                <?php echo $row['proprecio'] ?>
                            </td>
                            <td class="ov oc">
                                <a href="../../../sistema/procesos/edit/editarticulos.php?id=<?php echo $row['proid'] ?>"
                                    class="btn btn-secondary">
                                    <i class="fas fa-marker"></i>
                                </a>
                                <a href="../../../sistema/procesos/delete/deletearticulos.php?id=<?php echo $row['proid'] ?>"
