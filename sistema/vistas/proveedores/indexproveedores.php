    ...
    <div class="shadow-lg p-3 mb-5 bg-white rounded">
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col-md-9">
                        <h4>Administrador de Proveedores</h4>
                    </div>
                    <div class="col-md-3">
            ...
            ?>
                        ...
                        <div class="card card-body">
                            <form action="../../../sistema/procesos/save/saveproveedores.php" method="POST">
                                ...
                                <div class="form-group">
                                    <label>Nombre:</label>
                                    <input type="text" name="textpnom" class="form-control" placeholder="Ej: Gail Sanz"
                                        autofocus>
                                </div>
                                <div class="form-group">
                                    <label>Email:</label>
                                    <input type="text" name="textpemail" class="form-control"
                                        placeholder="Ej: gailsainz6823@gmail.com" autofocus>
                                </div>
                                <div class="form-group">
                                    <label>Direccion:</label>
                                    <input type="text" name="textpdire" class="form-control"
                                        placeholder="Ej: 2811 Orci Rd" autofocus>
                                </div>
                                <div class="form-group">
                                    <label>Telefono:</label>
                                    <input type="text" name="textptele" class="form-control" placeholder="Ej: 383938200"
                                        autofocus>
                                </div>
                ...
                while ($row = mysqli_fetch_array($resultado)) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php echo $row['provnom'] ?>
                                    </td>
                                    <td>
                                        <?php echo $row['provemail'] ?>
                                    </td>
                                    <td>
                                        <?php echo $row['provdire'] ?>
                                    </td>
                                    <td>
                                        <?php echo $row['provtele'] ?>
                                    </td>
                                    <td class="ov">
                                        <a href="../../../sistema/procesos/edit/editproveedores.php?id=<?php echo $row['provid'] ?>"
                                            class="btn btn-secondary">
                                            <i class="fas fa-marker"></i>
                                        </a>
                                        <a href="../../../sistema/procesos/delete/deleteproveedores.php?id=<?php echo $row['provid'] ?>"
                                            class="btn btn-danger od">
