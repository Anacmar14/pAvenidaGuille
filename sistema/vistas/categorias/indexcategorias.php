    ...
    <div class="shadow-lg p-3 mb-5 bg-white rounded">
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col-md-9">
                        <h4>Administrador de Categorias de Productos</h4>
                    </div>
                    <div class="col-md-3">
            ...
            <div class="card-body">
                ...
                ?>
                        <div class="shadow-lg p-3 mb-5 bg-#D3D3D3 rounded">
                                ...
                                <form action="../../../sistema/procesos/save/savecategorias.php" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="textcnom" class="form-control"
                                            placeholder="Ej: Bebida s/alcohol" autofocus>
                                    </div>
                    ...
                    while ($row = mysqli_fetch_array($resultado)) { ?>
                                <tr>
                                    ...
                                    <td class="ov">
                                        <a href="../../../sistema/procesos/edit/editcategorias.php?id=<?php echo $row['caid'] ?>"
                                            class="btn btn-secondary">
                                            <i class="fas fa-marker"></i>
                                        </a>
                                        <a href="../../../sistema/procesos/delete/deletecategorias.php?id=<?php echo $row['caid'] ?>"
