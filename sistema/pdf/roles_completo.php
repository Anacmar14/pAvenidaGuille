        ...
        else 
        {
            if (isset($_GET['pdf'])) 
            {
                ...
                if ($queryArticulos->num_rows > 0)
                {
                    ...
                    while ($fila = $queryArticulos->fetch_assoc())
                    {
                        ...
                        $pdf->Cell(25, 6, $fila["rolid"], 1, 0, 'C', 1);
                        $pdf->Cell(60, 6, $fila["rolnom"], 1, 1, 'C', 1);
                    }
                    $pdf->Output('', 'roles_completo.pdf');
            ...
            else
            {
                if (isset($_GET['excel'])) 
                {
                    ...
                    header('Content-Disposition: attachment;filename=roles_completo.xls');
