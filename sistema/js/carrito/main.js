...
$.ajax({
    ...
    function reloadProductTable(opcion, name) {
      ...
      tablaProductos = $(tablaName).DataTable({
          ...
          ajax: {
            url: "../../procesos/carrito/consCarrito.php",
  ...
  //ELIMINAR CAMPOS TABLA PRODUCTOSCOMP
    ...
    $(document).on("click", "#btnFinalizarComp", function () {
      if(arrayObjeto == 0){
        ...
        $("#facturaModal").html("<div class='totalt col-6'><div class='input-group-prepend'><span class='input-group-text'>MESA:</span></div><label id='facturaModalLabel' class='form-control'>"+6+"</label></div>");
